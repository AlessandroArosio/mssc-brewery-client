...
public class BlockingRestTemplateCustomiser implements RestTemplateCustomizer {
  ...
  public BlockingRestTemplateCustomiser(@Value("${sfg.max.total.connection}") Integer maxTotalConnections,
                                        @Value("${sfg.max.default.route}") Integer defaultMaxTotalConnections,
                                        @Value("${sfg.max.timeout}") Integer connectionRequestTimeout,
